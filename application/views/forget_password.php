...
<div class="container">
    ...
    <p class='text-danger' style="font-size:14pt; font-weight:bold; font-family:'Times New Roman', Times, serif">Type your CNIC NO (without dashes) to reset your password you will get an email of password reset request on your registered email address.</p>
