...
<div id = "min-height" class="container-fluid" style="padding:30px">
    <div class='card'>
        <div class='card-body'>
            <form action='<?=base_url()."AdminPanel/component_data"?>' enctype="multipart/form-data" onsubmit='return confirmForm()'  method='post'>
                    ...
                    if($id==="") {
                        ...
                        <div class='col-md-2'>
                            ...
                            <div class='form-group '>
                                ...
                                <input required class="form-control" type="number" name="order" min="1"
                ...
                foreach($list_of_section as $k=>$section){
                    ...
                    echo "<tr>
                            ...
                            <td><textarea>{$section}</textarea></td>
                             <td>\$COMPONENT_".$k."</td>
                            <td><a href='".base_url()."AdminPanel/component_data?index=$k&action=edit' class='btn btn-warning'>Edit</a></td>  
                                  </tr>";
                }
                ?>
            </table>
