...
<script src="<?=base_url()?>dash_assets/js/tree-line/jstree.min.js"></script>
<script src="<?=base_url()?>dash_assets/js/tree-line/jstree.active.js"></script>

<!-- main JS
    ============================================ -->
<script src="<?=base_url()?>dash_assets/js/main.js"></script>
<script src="<?=base_url()?>dash_assets/js/notifications/Lobibox.js"></script>
<script src="<?=base_url()?>dash_assets/js/notifications/notification-active.js"></script>
  <!-- chosen JS
		============================================ -->
		<script src="<?=base_url()?>dash_assets/js/chosen/chosen.jquery.js"></script>
<script src="<?=base_url()?>dash_assets/js/chosen/chosen-active.js"></script>
  
    <!-- select2 JS
		============================================ -->
		<script src="<?=base_url()?>dash_assets/js.select2/select2.full.min.js"></script>
<script src="<?=base_url()?>dash_assets/js/select2/select2-active.js"></script>
...
if(min_h){
    min_h.style="padding:30px;padding-top:60px;min-height:"+(window.innerHeight-80)+"px;";
}
