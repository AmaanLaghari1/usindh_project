<?php
$project_name ="University of Sindh";
?>
<!doctype html>
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script src="<?=base_url()?>dash_assets/js/vendor/jquery-1.12.4.min.js"></script>
        ...
        <!-- select2 CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>dash_assets/css/select2/select2.min.css">
    <!-- chosen CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>dash_assets/css/chosen/bootstrap-chosen.css">
    
    
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="<?=base_url()?>dash_assets/img/usindh_ico.ico">
...
<!--    <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,700,900" rel="stylesheet">-->
    ...
    <link rel="stylesheet" href="<?=base_url()?>dash_assets/css/tree-viewer/tree-viewer.css">
    <!-- animate CSS
		============================================ -->
    ...
    <link rel="stylesheet" href="<?=base_url()?>dash_assets/css/summernote/summernote.css">
            <!-- summernote CSS
    ============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>dash_assets/css/notifications/Lobibox.min.css">
    <link rel="stylesheet" href="<?=base_url()?>dash_assets/css/notifications/notifications.css">
