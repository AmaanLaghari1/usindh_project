        ...
        if(isset($_POST['submit'])
            ...
            if($check_cnic == "cnic" && !empty($cnic)){
                ...
                if($user) {
                    ...
                    $qualification = $this->User_model->getQulificatinByUserID_DEGREE_ID($user_id,2);
                 ...
                 }else
                 {
                    ...
                    if($update_token == 1)
                    {
						...
						sendPasswordTokenByEmail($EMAIL,$code,$user_id,$this);					
                    ...
                    $this->session->set_flashdata('ALERT_MSG', $error);
                    $this->log_model->create_log(0,0,'','',"INVALID_CNIC",'users_reg',22,0);
